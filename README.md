...
- **Playable on all difficulties.** (Monk gets more energy from fruits to compensate for the lack of fauna; Survivor probably needs to move a lot (I recommend the [HunterSpawns](https://drive.google.com/file/d/1VlO82XQMyXaY79xhIF2rRuiWxUYStPFu/view) mod); The Hunter is not affected by some of the changes (eg. starting position))  
