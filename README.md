...
<details>  
  ...
  **o** All Slugcats use quarterPoints, and only the Monk gets full points from fruits (only the blue fruits).  
  **o** The appetite, based on _current_ Karma, ranges from half the Hunters to double. Something like that.  
  **o** The Slugcat no longer glows when it eats a neuron. Instead it gains glow on Karma 5 with some food.  
  **o** After reaching Karma 7, spear pull and crafting becomes free.  
  **o** Karma 10 doubles all stat bonuses.  
